...
// --- Navigation Logic (Explicitly Enhanced) ---
function initAppNavigation() {
    // Handle the main navigation buttons
...
const diseaseRegistry = {
    ...
    "اعتلال الأعصاب": { nature: "cold-dry", organ: "nerves", tip: "تحتاج لترطيب الأعصاب بدهن اللوز وتدفئتها بالمسخنات اللطيفة كالبابونج، وتجنب الحوامض." },
    "الدوخة": { nature: "hot-dry", organ: "brain", tip: "تسكين حدة الصفراء بشم المبردات (ورد، خل) وشرب ماء الشعير وتجنب السهر." },
    "الصداع النصفي": { nature: "hot-dry", organ: "brain", tip: "تحتاج لردع المادة ومنع انصبابها، واستخدام دهن البنفسج أو الخل والورد." },
    "مرض الزهايمر": { nature: "cold-dry", organ: "brain", tip: "ترطيب الدماغ بالأدهان (زيت لوز وجوز) وتنشيط الذاكرة باللبان الذكر." },
    "السكتة الدماغية": { nature: "cold-moist", organ: "brain", tip: "حالة حرجة ناتجة عن سدد؛ الوقاية بمميعات طبيعية كالثوم والرياضة." },
    "التصلب المتعدد": { nature: "cold-dry", organ: "brain", tip: "تحتاج لمساج بالزيوت المسخنة (زيت الخردل) ورفع حرارة البدن الغريزية." },
    "الاكتئاب": { nature: "cold-dry", organ: "brain", tip: "تنقية السوداء العكرة بالمرطبات المبهجة كالتفاح واليقطين والجلوس في الخضرة." },
    "اضطراب القلق": { nature: "hot-dry", organ: "brain", tip: "تبريد نار الصفراء بماء الشعير، السباحة، وشم الريحان والورد." },
    "اضطراب الهلع": { nature: "hot-dry", organ: "brain", tip: "دليل على فورة ريح صفراوية؛ تبريد الوجه بماء بارد وشم الورد والخل." },
    "اضطراب فرط الحركة": { nature: "hot-moist", organ: "brain", tip: "تقليل السكريات والمحفزات، والتركيز على الهدوء والأغذية المبردة." },
    "الإدمان الرقمي": { nature: "hot-dry", organ: "brain", tip: "إجهاد للروح الباصرة؛ العلاج بالانقطاع التام والنظر في الطبيعة." },
    "اضطراب النوم": { nature: "hot-dry", organ: "brain", tip: "ترطيب الدماغ بماء الشعير واليقطين ودهن الرأس بزيت البنفسج." },
    ...
    "سعال جاف": { nature: "hot-dry", organ: "lung", tip: "ترطيب الحنجرة باللعابات (بزر كتان) وشرب لبن اللوز وتجنب الحريف والحامض." },
    "انفلونزا": { nature: "cold-moist", organ: "lung", tip: "تنشيف الرطوبات بالمسخنات (زنجبيل، قرفة) والتبخر بمغلي الشيح والقيصوم." },
    "زكام": { nature: "cold-moist", organ: "brain", tip: "استنشاق الأبخرة العطرية (مرامية) وتدفئة الرأس ومنع الألبان والبارد." },
    "برد": { nature: "cold-moist", organ: "lung", tip: "تدفئة البدن بالأغذية الحارة وشراب العسل والليمون الدافئ." },
    "التهاب الشعب": { nature: "cold-moist", organ: "lung", tip: "تنقية البلغم بالزوفا والصموغ (مثل اللبان الذكر) والعسل." },
    "الانسداد الرئوي": { nature: "cold-dry", organ: "lung", tip: "تحتاج لترطيب الصدر ومنع التدخين والغبار واستخدام زيت السمسم." },
    "الالتهاب الرئوي": { nature: "hot-moist", organ: "lung", tip: "تبريد الصدر بماء الشعير ولبن اللوز والراحة التامة." },
    "الحساسية التنفسية": { nature: "hot-moist", organ: "lung", tip: "تقليل الرطوبات الهائجة بالتقليل من الألبان واستخدام العسل المر." },
    ...
    "نقص الحديد": { nature: "cold-dry", organ: "liver", tip: "تناول الكبد الطازج، الدبس، والزبيب الأسود، وتعزيز الهضم لامتصاص الغذاء." },
    "فقر الدم المنجلي": { nature: "cold-dry", organ: "liver", tip: "يحتاج لترطيب مستمر وتدفئة البدن وتجنب الجفاف والبرد الشديد." },
    "الثلاسيميا": { nature: "cold-dry", organ: "liver", tip: "دعم القوة الغريزية بالغذاء اللطيف السهل الهضم وتجنب الإجهاد البدني." },
    "ارتجاع": { nature: "cold-moist", organ: "stomach", tip: "تقوية فم المعدة بالقوابض (سفرجل) ومنع النوم بعد الأكل مباشرة." },
    "جرثومة": { nature: "cold-moist", organ: "stomach", tip: "تغيير بيئة المعدة بالخل الطبيعي المخفف والقشور الرمان المغلية وتناول الثوم." },
    "مقاومة الانسولين": { nature: "cold-moist", organ: "liver", tip: "تنشيف الرطوبات الزائدة بالرياضة والقرفة والخل، وتقليل النشويات تماماً." },
    "الغدة الدرقية": { nature: "cold-moist", organ: "none", tip: "تحتاج لتنشيط وتسخين البدن باليود الطبيعي (أعشاب بحرية) والتدليك بزيت القسط." },
    "كيتونات": { nature: "hot-dry", organ: "liver", tip: "إطفاء حدة الاحتراق بالسوائل المرطبة وماء الشعير واليقطين." },
    "الكبد الدهني": { nature: "cold-moist", organ: "liver", tip: "تنشيف رطوبة الكبد بالمرارات كالهندباء، وتقليل النشويات والسكريات." },
    "تليف الكبد": { nature: "cold-dry", organ: "liver", tip: "ترطيب الكبد بالعسل والزعفران ومنع المواد اليابسة والمملحة." },
    "حصى المرارة": { nature: "cold-dry", organ: "liver", tip: "تحليل الحصى بالخل والليمون وزيت الزيتون على الريق." },
    "التهاب البنكرياس": { nature: "hot-moist", organ: "stomach", tip: "تبريد موضع المعدة بالكمادات الباردة وماء الشعير والراحة عن الأكل." },
    "السكري النوع الاول": { nature: "cold-moist", organ: "liver", tip: "منشأه قد يختلف؛ غالباً ما يرتبط ببرودة الكبد وضعف القوة الغريزية، ويحتاج لتقوية وتنظيم دقيق." },
    "السكري النوع الثاني": { nature: "cold-moist", organ: "liver", tip: "منشأه غالباً من فضول رطوبية وسدد؛ يُعالج بالرياضة والقرفة لإذابة الرطوبات المحتبسة." },
    "السكري الحملي": { nature: "hot-moist", organ: "liver", tip: "منشأه فورة دم مؤقتة؛ يُبرد بالرمان والتفاح اللطيف والمشي الهادئ." },
    "السمنة المرضية": { nature: "cold-moist", organ: "none", tip: "تنشيف البدن بالرياضة، خل التفاح، وتقليل الوجبات." },
    "متلازمة الأيض": { nature: "cold-moist", organ: "liver", tip: "إصلاح الهضم الأساسي ومنع تراكم الأخلاط اللزجة بالحركة." },
    "القولون الالتهابي": { nature: "hot-moist", organ: "stomach", tip: "ترميم الغشاء المخاطي باللعابيات (بزر قطونا) ومنع الحوار." },
    "التهاب الأمعاء المزمن": { nature: "hot-moist", organ: "stomach", tip: "تحتاج لغذاء سهل الامتصاص كمرق العظام وتجنب البقوليات." },
    "السلياك": { nature: "hot-moist", organ: "stomach", tip: "حساسية شديدة؛ يمنع الجلوتين وتُرمم الأمعاء بالعسل ومرق الدجاج." },
    "حساسية الطعام": { nature: "hot-moist", organ: "stomach", tip: "دليل على فورة دم؛ تُبرد بالخل المخفف ويُمنع المسبب فوراً." },
    "اختلال التوازن الهرموني": { nature: "cold-dry", organ: "none", tip: "ضبط النوم، وتقليل التوتر، واستخدام الأعشاب الموازنة كالميرمية." },
    ...
    "التهاب المسالك": { nature: "hot-dry", organ: "none", tip: "تبريد المجرى بالسوائل المدرة (ماء بقدونس) وماء الشعير." },
    "التهاب الكلى": { nature: "hot-moist", organ: "none", tip: "تبريد الكليتين بالكمادات والابتعاد عن الأملاح والبروتينات الكثيرة." },
    "البروستاتا": { nature: "cold-moist", organ: "none", tip: "تدفئة الموضع وتناول بذور اليقطين والابتعاد عن البرد." },
    "التهاب المهبل": { nature: "hot-moist", organ: "none", tip: "تبريد الموضع بمغلي البابونج أو الخل المخفف (إذا كانت فطرية)." },
    "العقم": { nature: "cold-dry", organ: "none", tip: "يحتاج لرفع الحرارة والرطوبة الغريزية بالغذاء القوي (عسل، لقاح نخل)." },
    "التهابات الرحم": { nature: "hot-moist", organ: "none", tip: "تبريد داخلي بالحمامات المائية الملطفة والغذاء البارد الرطب." },
    "ضعف الانتصاب": { nature: "cold-moist", organ: "none", tip: "رفع الروح المسخنة بالرياضة والأغذية القوية كالمحار والعسل." },
    "سن اليأس المبكر": { nature: "cold-dry", organ: "none", tip: "ترطيب البدن بالمستحلبات (حلبه، يانسون) والزيوت الطبيعية." },
    "ارتفاع البرولاكتين": { nature: "cold-moist", organ: "none", tip: "تنشيف الرطوبة الزائدة بالبردقوش ومنع الألبان." },
    "ارتفاع هرمون الحليب": { nature: "cold-moist", organ: "none", tip: "تنشيف الرطوبة الزائدة بالبردقوش ومنع الألبان." },
    ...
    "دوالي": { nature: "cold-dry", organ: "none", tip: "تحليل غلظ الدم بالسنا والسنوت، ورفع الساقين للأعلى، وتجنب الوقوف الطويل." },
    "هالات سوداء": { nature: "cold-dry", organ: "none", tip: "دليل على تعب الكبد أو أرق؛ علاجها بترطيب الدماغ ودهن زيت اللوز المر." },
    "نمش": { nature: "cold-dry", organ: "none", tip: "تنقية الكبد داخلياً بالهندباء، وطلاء موضع النمش بماء البصل والخل." },
    "هربس": { nature: "hot-dry", organ: "none", tip: "تبريد الموضع بماء الورد والنشا، وتقوية المناعة بالعسل والقسط." },
    ...
    "الذبحة الصدرية": { nature: "cold-dry", organ: "heart", tip: "تحتاج لتقوية القلب بالروائح الطيبة (مسك، ورد) والتدفئة والسكينة." },
    "الجلطة القلبية": { nature: "cold-moist", organ: "heart", tip: "سدة في المجاري؛ الوقاية بالثوم والزنجبيل ومميعات الدم الطبيعية." },
    "قصور القلب": { nature: "cold-moist", organ: "heart", tip: "تقوية عضلة القلب بالمفرحات المسخنة لزيادة القوة الغريزية." },
    "اضطراب النظم": { nature: "hot-dry", organ: "heart", tip: "تهدئة الروح القلبية بماء الورد، التنفس العميق، ومنع المنبهات." },
    "الجلطات الدموية": { nature: "cold-moist", organ: "heart", tip: "منع ركود الدم بالحركة المستمرة وشرب المذيبات كالقرفة." },
    "خشونة المفاصل": { nature: "cold-dry", organ: "none", tip: "ترطيب المفصل بالتمريخ بزيت الزيتون وتناول مرق العظام (الكولاجين)." },
    "انزلاق غضروفي": { nature: "cold-moist", organ: "none", tip: "تخفيف الضغط بالراحة، والحجامة التحليلية بعد هدوء الألم الحاد." },
    "هشاشة العظام": { nature: "cold-dry", organ: "none", tip: "تقوية العظام بالأغذية الكلسية (سمسم، تين) والتعرض للشمس." },
    "روماتيزم مناعي": { nature: "hot-moist", organ: "none", tip: "تبريد الالتهاب داخلياً بالكركم ثم تنقية البدن من الرطوبات الغريبة." },
    "خشونة الركبة": { nature: "cold-dry", organ: "none", tip: "دهن الركبة باللية المذابة مع الزيوت ومنع البرد المباشر." },
    "نقص المناعة": { nature: "cold-moist", organ: "none", tip: "تقوية المناعة بالعسل والقسط الهندي والحبة السوداء." },
    "المناعة الذاتية": { nature: "hot-dry", organ: "none", tip: "موازنة الأخلاط ومنع الاحتراق الداخلي بالحمية السليمة والهدوء النفسي." },
    "الذئبة الحمراء": { nature: "hot-moist", organ: "none", tip: "تبريد الدم وتنقيته من الأخلاط المحترقة، وتجنب الشمس." },
    "التهاب الغدة المناعي": { nature: "hot-dry", organ: "none", tip: "تقليل الالتهاب بالكركم وأوميغا 3 الطبيعي ومنع مسببات التحسس." },
    "حب الشباب": { nature: "hot-moist", organ: "none", tip: "تنقية الدم والكبد بالعسل والليمون وطلاء الوجه بماء الورد." },
    "الفطريات الجلدية": { nature: "cold-moist", organ: "none", tip: "تجفيف الموضع بالخل والثوم ومنع الرطوبة المحتبسة." },
    "الثعلبة": { nature: "cold-moist", organ: "none", tip: "فرك الموضع بالثوم لجذب الدم والحرارة لفتح المسام المسدودة." },
    "كوفيد-19": { nature: "hot-moist", organ: "lung", tip: "تقوية المناعة، تبخر بالبابونج، وشرب المشروبات المسخنة والترطيب." },
    "التهاب الكبد الفيروسي": { nature: "hot-moist", organ: "liver", tip: "تبريد الكبد بالهندباء والسكر الطبيعي (عنب) لتقوية طاقة العضو." },
    "فيروس نقص المناعة": { nature: "cold-moist", organ: "none", tip: "تقوية البدن بأقصى أنواع المغذيات ومنع أسباب الوهن." },
    "تخثر الدم": { nature: "cold-moist", organ: "none", tip: "منع الجمود بالسيولة الطبيعية (زنجبيل) والحركة الدائمة." },
    "سرطان": { nature: "cold-dry", organ: "none", tip: "ناتج عن يبوسة واحتراق سوداوي؛ يحتاج لترطيب عميق وتنقية البدن من السموم." },
    "سرطان الدم": { nature: "hot-dry", organ: "none", tip: "فورة محترقة في الدم؛ تحتاج لتنقية الأخلاط السوداوية بالمنضجات والمسهلات اللطيفة." },
    "سرطان الثدي": { nature: "cold-dry", organ: "none", tip: "تنقية الخلط السوداوي المحترق، وتجنب الهموم، وترطيب البدن بالأغذية اللطيفة." },
    "سرطان القولون": { nature: "cold-dry", organ: "stomach", tip: "منع الإمساك تماماً، وتناول الألياف والزيوت المرطبة كزيت الزيتون." },
    "سرطان الرئة": { nature: "cold-dry", organ: "lung", tip: "استنشاق الهواء النقي، وترطيب الصدر بلعاب السفرجل وبزر الكتان." },
    "سرطان الكبد": { nature: "cold-dry", organ: "liver", tip: "حماية ما تبقى من قوة الكبد بالهندباء والعسل وتجنب الأدوية المجهدة." },
    "سرطان البروستاتا": { nature: "cold-dry", organ: "none", tip: "تقليل اللحوم الحمراء والدمويات، والتركيز على اليقطين والمرطبات." },
    "سرطان الجلد": { nature: "cold-dry", organ: "none", tip: "حماية الجلد من الاحتراق الخارجي بالترطيب والدهون الباردة كالورد." },
    "فقر الدم المنجلي": { nature: "cold-dry", organ: "liver", tip: "يحتاج لترطيب مستمر وتدفئة البدن وتجنب الجفاف والبرد الشديد." },
    "الثلاسيميا": { nature: "cold-dry", organ: "liver", tip: "دعم القوة الغريزية بالغذاء اللطيف السهل الهضم وتجنب الإجهاد البدني." },
    "نقص الحديد": { nature: "cold-dry", organ: "liver", tip: "تناول الكبد الطازج، الدبس، والزبيب الأسود، وتعزيز الهضم لامتصاص الغذاء." },
    "اختلال التوازن الهرموني": { nature: "cold-dry", organ: "none", tip: "ضبط النوم، وتقليل التوتر، واستخدام الأعشاب الموازنة كالميرمية." },
    "ارتفاع هرمون الحليب": { nature: "cold-moist", organ: "none", tip: "تنشيف الرطوبة الزائدة بالبردقوش ومنع الألبان." },
    "ارتفاع البرولاكتين": { nature: "cold-moist", organ: "none", tip: "تنشيف الرطوبة الزائدة بالبردقوش ومنع الألبان." },
    "ارتفاع الكورتيزول": { nature: "hot-dry", organ: "none", tip: "الناتج عن التوتر؛ علاجه بالسكون والنوم المبكر والمشروبات المهدئة." },
    "السل": { nature: "hot-dry", organ: "lung", tip: "تحتاج للترطيب الشديد بالألبان والماء البارد وإطفاء حرارة الرئة." },
    "فيروس نقص المناعة": { nature: "cold-moist", organ: "none", tip: "تقوية البدن بأقصى أنواع المغذيات ومنع أسباب الوهن." },
    "حساسية الجلد": { nature: "hot-moist", organ: "none", tip: "تبريد الجلد بالنشا وماء الورد ومنع المثيرات الحارة (الفلفل)." },
    "حساسية الأنف": { nature: "hot-moist", organ: "none", tip: "غسل الجيوب بماء وملح مخفف، وتجنب الروائح الكيميائية." },
    "الشرى": { nature: "hot-moist", organ: "none", tip: "إطفاء فورة الدم بماء الشعير البارد والطلاء بالخل المخفف." },
    "خمول الغدة": { nature: "cold-moist", organ: "none", tip: "تنشيط البدن بالمسخنات (قسط، قرفة) واليود الطبيعي." },
    "نشاط الغدة": { nature: "hot-dry", organ: "none", tip: "تبريد البدن بماء الشعير والقرع والهدوء وتجنب المحفزات." },
    "الكورتيزول": { nature: "hot-dry", organ: "none", tip: "الناتج عن التوتر؛ علاجه بالسكون والنوم المبكر والمشروبات المهدئة." },
    "الإجهاد المزمن": { nature: "cold-dry", organ: "none", tip: "ترميم القوى المنهكة بالتدفئة، التالبينة، والراحة الطويلة." },
    "تعب مزمن": { nature: "cold-moist", organ: "none", tip: "تنشيط الكبد وتحسين جودة النوم وتناول فيتامينات الدم الطبيعية." },
    "فيبروميالجيا": { nature: "cold-dry", organ: "none", tip: "ترطيب الأعصاب وتدفئة المفاصل بالزيوت، وتحسين الحالة النفسية." },
...
// --- SMART CLINIC REMEDY DATABASE (Based on Al-Mughni & Ibn Sina & herbs_database.csv) ---
const remedyDatabase = {
    maturation: {
        cold: {
            title: "منضجات الأخلاط الباردة (البلغم والسوداء)",
            items: [
                { herb: "البابونج وإكليل الملك واليانسون", prep: "تُغلى الأعشاب معاً في لتر ماء وتُصفى جيداً.", dose: "كوب دافئ 3 مرات يومياً قبل الأكل بـ 30 دقيقة.", duration: "يستمر عليها حتى يرق قوام البول ويصفو لونه." },
                { herb: "القسط الهندي الممزوج بالعسل", prep: "يُخلط مسحوق القسط الهندي مع عسل سدر أصلي.", dose: "ملعقة صغيرة على الريق يومياً.", duration: "لمدة 21 يوماً لتنقية السدد العميقة." },
                { herb: "السذاب مع الزيت العتيق", prep: "يُطبخ السذاب في زيت زيتون قديم حتى يلين.", dose: "استخدام دهون أو شرب مقادير يسيرة.", duration: "حتى يزول ثقل المفاصل والرياح الغليظة." }
            ]
        },
        hot: {
            title: "منضجات الأخلاط الحارة (الدم والصفراء)",
            items: [
                { herb: "ماء الشعير المصفى (كشك الشعير)", prep: "يُغلى الشعير في لترين ماء حتى نضجه تماماً ثم يُصفى.", dose: "كوب واحد كل 4 ساعات لتبريد الكبد والدم.", duration: "لمدة 3-5 أيام لإطفاء لهيب الحرارة." },
                { herb: "البنفسج والورد الجوري والنيوفر", prep: "نقع الورد والبنفسج في ماء فاتر ليلة كاملة وشربه.", dose: "كوب على الريق يومياً لتسكين غليان الدم.", duration: "حتى يهدأ النبض وتقل حمرة الوجه والبدن." },
                { herb: "لعاب بزر قطونا (الإسبغول)", prep: "تُوضع ملعقة في كوب ماء دافئ وتُترك لتتكون الطبقة الهلامية.", dose: "شرب اللعاب اللزج الفاتر (تحذير: لا يُشرب البذر نفسه).", duration: "لتسكين حدة ولدغ المادة الصفراوية في الأمعاء." }
            ]
        }
    },
    purging: {
        yellow: { herb: "الإهليلج الأصفر وخيار شنبر", prep: "يُطبخ خيار شنبر ويُهرس ثم يُضاف إليه مسحوق الإهليلج الأصفر.", dose: "ملعقة كبيرة على الريق مع ماء فاتر.", duration: "مرة واحدة أسبوعياً لتنقية الصفراء من المعدة والكبد." },
        phlegm: { herb: "التُّرْبِد (التربد الأبيض) مع الزنجبيل", prep: "يُخلط التربد المطحون مع قليل من العسل والزنجبيل لإصلاحه.", dose: "ملعقة صغيرة صباحاً قبل الإفطار بساعتين.", duration: "3 أيام متتالية لطرد البلغم من أقصى البدن." },
        black: { herb: "الأفتيمون (ملك تنقية السوداء)", prep: "يُنقع في ماء ساخن ولا يُغلى أبداً (لأن غليه يطفي قوته).", dose: "كوب صغير (فنجان) قبل النوم مباشرة.", duration: "لمدة 5-7 أيام حتى تذهب الوساوس والهم والكمود." },
