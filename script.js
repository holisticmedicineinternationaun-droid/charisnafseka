...
const trickyQuestions = [
    {
        ...
        isCorrect: false,
        explanation: "لا، هذا خطأ! المعدة تحتاج للدفء في الصباح، والماء البارد يصدم الحرارة الغريزية."
    },
    {
        botText: "صديقي ذو المزاج (البلغمي) يأكل الكثير من الفلفل والزنجبيل (حار بمرتبة ثالثة).. هل يصيب؟",
        isCorrect: true,
        explanation: "أحسنت! هذا صحيح، فالمزاج البلغمي الزائد البرودة والرطوبة يحتاج لأعشاب مجففة لتعديله."
    },
    {
        botText: "قرأت أن الأرز حار معتدل عند جميع أطباء اليونان والعرب ولا يوجد خلاف فيه. صحيح؟",
        isCorrect: false,
        explanation: "للأسف، لقد وقعت في الفخ! ابن سينا يراه حاراً معتدلاً بينما يراه آخرون بارداً يابساً."
    }
];
